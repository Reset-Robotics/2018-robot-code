...
public class OI 
{
	...
	public double drivetrainLeft, drivetrainRight;
	public Button shiftDrivetrain, backBeltsIn, backBeltsOut, toggleIntakePistons, intakeWheelsForward, intakeWheelsReverse, stopIntakes;
	public Button liftWheelsOut, liftWheelsIn, drivetrainTank, drivetrainArcade;
