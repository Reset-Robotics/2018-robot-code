...
val joystickLeftIDs = HashMap<String, Integer>() // holds ids for different buttons and axes on the left driver joystick
...
val joystickRightIDs = HashMap<String, Integer>() // holds ids for different buttons and axes on the right driver joystick
...
val xboxIDs = HashMap<String, Integer>() // holds ids for different buttons and axes on the xbox controller
...
val driveMotorIDs = HashMap<String, Integer>() // holds all our talon ids for drive motors
...
val liftMotorIDs = HashMap<String, Integer>() // holds all our motor controller ids for lift motors
liftMotorIDs.put("Left-Master", 0)
liftMotorIDs.put("Right-Master", 1)

val pwmMotorIDs = HashMap<String, Integer>() // holds all our PWM ids
...
val shifterSolenoidPorts = HashMap<String, Integer>() // holds our solenoid ports on the PCM for our drivetrain shifter
shifterSolenoidPorts.put("Left-Port", 0)
shifterSolenoidPorts.put("Right-Port", 1)

val intakeSolenoidPorts = HashMap<String, Integer>() // holds our solenoid ports on the PCM for our intake pistons
